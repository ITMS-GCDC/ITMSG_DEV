...
SELECT 
    'SR002' as sr_number,
    '상승물산 스마트 빌딩 시스템 구축 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
SELECT 
    'SR003' as sr_number,
    '상승생명 디지털 보험 플랫폼 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
SELECT 
    'SR004' as sr_number,
    '상승화재 디지털 손해사정 시스템 구축 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
SELECT 
    'SR007' as sr_number,
    '상승바이오로직스 바이오의약품 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
SELECT 
    'SR008' as sr_number,
    '상승엔지니어링 스마트 플랜트 구축 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
-- 한리자동차그룹 파트너 기준 SR 생성
-- PAR010: 한리자동차 파트너
INSERT INTO service_requests (sr_number, title, sr_type, sr_category, status, business_requirement, project_id, requester_id, requester_dept_id, request_date, due_date, created_by, updated_by)
SELECT 
    'SR009' as sr_number,
    '한리자동차 전기차 플랫폼 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
SELECT 
    'SR011' as sr_number,
    '한리모비스 차량용 소프트웨어 플랫폼 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
SELECT 
    'SR013' as sr_number,
    '한리글로비스 스마트 물류 시스템 구축 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
SELECT 
    'SR016' as sr_number,
    '한리오토에버 자동차 소프트웨어 개발 플랫폼 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'SL-hynix@partner.com'
...
SELECT 
    'SR018' as sr_number,
    'SL이노베이션 친환경 에너지 솔루션 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'SL-innovation@partner.com'
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'SL-telecom@partner.com'
...
SELECT 
    'SR020' as sr_number,
    'SL스퀘어 반도체 투자 플랫폼 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'SL-square@partner.com'
...
SELECT 
    'SR021' as sr_number,
    'SL디스커버리 신사업 발굴 플랫폼 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'SL-discovery@partner.com'
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'SLc@partner.com'
...
SELECT 
    'SR023' as sr_number,
    'SL가스 스마트 가스 관리 시스템 구축 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'SL-gas@partner.com'
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'SL-move@partner.com'
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'LK-electronics@partner.com'
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'LK-chemical@partner.com'
...
SELECT 
    'SR027' as sr_number,
    'LK디스플레이 차세대 디스플레이 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'LK-display@partner.com'
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'LK-innotek@partner.com'
...
SELECT 
    'SR029' as sr_number,
    'LK유플러스 IoT 서비스 플랫폼 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'LK-uplus@partner.com'
...
SELECT 
    'SR030' as sr_number,
    'LK생활건강 스마트 코스메틱 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'LK-life@partner.com'
...
SELECT 
    'SR031' as sr_number,
    'LK CNS 클라우드 보안 솔루션 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'LK-cns@partner.com'
...
SELECT 
    'SR032' as sr_number,
    'LK상사 글로벌 무역 플랫폼 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'LK-trading@partner.com'
...
SELECT 
    'SR033' as sr_number,
    '롯태제과 스마트 제조 시스템 구축 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'lostae-confectionery@partner.com'
...
SELECT 
    'SR034' as sr_number,
    '롯태칠성음료 스마트 물류 시스템 구축 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
    '스마트 물류 시스템 구축 요청' as business_requirement,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'lostae-chilsung@partner.com'
JOIN departments d ON d.name = '물류운영팀'
...
SELECT 
    'SR035' as sr_number,
    '롯태마트 디지털 매장 관리 시스템 구축 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'lostae-mart@partner.com'
...
SELECT 
    'SR036' as sr_number,
    '롯태백화점 스마트 쇼핑 플랫폼 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'lostae-department@partner.com'
...
SELECT 
    'SR037' as sr_number,
    '롯태호텔 스마트 투숙 시스템 구축 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'lostae-hotel@partner.com'
...
SELECT 
    'SR038' as sr_number,
    '롯태푸드 스마트 생산 관리 시스템 구축 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'lostae-food@partner.com'
JOIN departments d ON d.name = '생산기술팀'
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'lostae-rental@partner.com'
...
SELECT 
    'SR040' as sr_number,
    '롯태손해보험 디지털 보험 서비스 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'lostae-insurance@partner.com'
JOIN departments d ON d.name = '디지털전략팀'
...
SELECT 
    'SR041' as sr_number,
    'GGS칼텍스 스마트 에너지 관리 시스템 구축 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'GGS-calnex@partner.com'
...
SELECT 
    'SR042' as sr_number,
    'GGS리테일 편의점 디지털 전환 프로젝트 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'GGS-retail@partner.com'
...
SELECT 
    'SR043' as sr_number,
    'GGS건설 스마트 건설 플랫폼 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'GGS-construction@partner.com'
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'GGS-global@partner.com'
JOIN departments d ON d.name = '글로벌사업팀'
...
SELECT 
    'SR045' as sr_number,
    'GGS EPS 에너지 솔루션 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'GGS-eps@partner.com'
...
SELECT 
    'SR046' as sr_number,
    'GGS네오텍 스마트 팩토리 솔루션 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'GGS-neotech@partner.com'
...
SELECT 
    'SR047' as sr_number,
    'GGS수퍼마켓 디지털 매장 관리 시스템 구축 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
    '디지털 매장 관리 시스템 구축 요청' as business_requirement,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'GGS-supermarket@partner.com'
JOIN departments d ON d.name = '점포운영팀'
...
SELECT 
    'SR048' as sr_number,
    'GGS홈쇼핑 모바일 쇼핑 플랫폼 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'GGS-homeshopping@partner.com'
...
SELECT 
    'SR049' as sr_number,
    '한파솔루션 태양광 에너지 솔루션 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'hanpa-solution@partner.com'
JOIN departments d ON d.name = '신재생에너지팀'
WHERE p.code = 'PAR050' AND pr.code = 'PROJ049'
LIMIT 1
ON CONFLICT (sr_number) DO NOTHING;

-- PAR051: 한파에어로스페이스 파트너
INSERT INTO service_requests (sr_number, title, sr_type, sr_category, status, business_requirement, project_id, requester_id, requester_dept_id, request_date, due_date, created_by, updated_by)
SELECT 
    'SR050' as sr_number,
    '한파에어로스페이스 항공우주 소프트웨어 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'hanpa-aerospace@partner.com'
...
SELECT 
    'SR051' as sr_number,
    '한파시스템 국방 IT 솔루션 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'hanpa-system@partner.com'
...
SELECT 
    'SR052' as sr_number,
    '한파에너지 스마트 그리드 시스템 구축 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'hanpa-energy@partner.com'
...
SELECT 
    'SR053' as sr_number,
    '한파생명 디지털 보험 플랫폼 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
    '디지털 보험 플랫폼 개발 요청' as business_requirement,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'hanpa-life@partner.com'
JOIN departments d ON d.name = '디지털전략팀'
...
SELECT 
    'SR054' as sr_number,
    '한파손해보험 인슈어테크 솔루션 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'hanpa-insurance@partner.com'
...
SELECT 
    'SR055' as sr_number,
    '한파투자증권 모바일 트레이딩 플랫폼 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'hanpa-securities@partner.com'
JOIN departments d ON d.name = '플랫폼개발팀'
...
SELECT 
    'SR056' as sr_number,
    '한파자산운용 로보어드바이저 플랫폼 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'hanpa-asset@partner.com'
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'daegu-shipbuilding@partner.com'
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'daegu-construction@partner.com'
JOIN departments d ON d.name = '스마트건설팀'
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'daegu-industry@partner.com'
...
SELECT 
    'SR060' as sr_number,
    '대구중공업 대형 설비 제어 시스템 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'daegu-heavy@partner.com'
...
SELECT 
    'SR061' as sr_number,
    '대구조선 선박 설계 자동화 시스템 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'daegu-ship@partner.com'
...
SELECT 
    'SR062' as sr_number,
    '대구해양 해양 구조물 설계 시스템 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'daegu-ocean@partner.com'
...
SELECT 
    'SR063' as sr_number,
    '한증항공 스마트 항공기 관리 시스템 구축 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'hanjeung-air@partner.com'
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'hanjeung@partner.com'
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'hanjeung-kal@partner.com'
...
SELECT 
    'SR066' as sr_number,
    '한증통운 실시간 배송 추적 시스템 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'hanjeung-express@partner.com'
...
SELECT 
    'SR067' as sr_number,
    '한증중공업 대형 크레인 제어 시스템 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'hanjeung-heavy@partner.com'
...
SELECT 
    'SR068' as sr_number,
    '한증해운 선박 운항 최적화 시스템 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'hanjeung-shipping@partner.com'
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'navergo@partner.com'
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'kakaogo@partner.com'
JOIN departments d ON d.name = '모빌리티팀'
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'coupango@partner.com'
...
SELECT 
    'SR076' as sr_number,
    '배달의민족고 스마트 주문 시스템 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'baedalgo@partner.com'
...
SELECT 
    'SR077' as sr_number,
    '야놀자고 숙박 플랫폼 AI 최적화 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'yanoljago@partner.com'
...
SELECT 
    'SR078' as sr_number,
    '무신사고 패션 AI 추천 시스템 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'musinsago@partner.com'
...
SELECT 
    'SR079' as sr_number,
    '당근마켓고 중고거래 AI 매칭 시스템 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'danggeungo@partner.com'
...
SELECT 
    'SR080' as sr_number,
    '요기요고 실시간 배달 최적화 시스템 개발 요청' as title,
    'DEVELOPMENT' as sr_type,
    'AP_DEVELOPMENT' as sr_category,
    'APPROVAL_REQUESTED' as status,
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'yogiyogo@partner.com'
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'linego@partner.com'
...
FROM partners p 
JOIN projects pr ON p.id = pr.company_id
JOIN users u ON u.email = 'tossgo@partner.com'
...
-- NumberinGGService에서 사용하는 SR 코드 시퀀스 초기화
