...
-- 의존성 조사: ProjectService, ProjectRepository, PartnerRepository, NumberinGGService
...
SELECT 
    'PROJ007' as code,
    '상승바이오로직스 바이오의약품 개발 프로젝트' as name,
    'SI' as project_type,
    'IN_PROGRESS' as status,
...
SELECT 
    'PROJ008' as code,
    '상승엔지니어링 스마트 플랜트 구축 프로젝트' as name,
    'SI' as project_type,
    'IN_PROGRESS' as status,
...
-- 한리자동차그룹 파트너 기준 프로젝트 생성
-- PAR010: 한리자동차 파트너
INSERT INTO projects (code, name, project_type, status, start_date, end_date, company_id, created_by, updated_by)
SELECT 
    'PROJ009' as code,
    '한리자동차 전기차 플랫폼 개발 프로젝트' as name,
    'SI' as project_type,
    'IN_PROGRESS' as status,
...
SELECT 
    'PROJ011' as code,
    '한리모비스 차량용 소프트웨어 플랫폼 개발' as name,
    'SI' as project_type,
    'IN_PROGRESS' as status,
...
SELECT 
    'PROJ015' as code,
    '한리제철 스마트 제철 공정 개선 프로젝트' as name,
    'SI' as project_type,
    'IN_PROGRESS' as status,
...
SELECT 
    'PROJ016' as code,
    '한리오토에버 자동차 소프트웨어 개발 플랫폼' as name,
    'SI' as project_type,
    'IN_PROGRESS' as status,
...
SELECT 
    'PROJ017' as code,
    'SL하이닉스 차세대 메모리 개발 프로젝트' as name,
    'SI' as project_type,
    'IN_PROGRESS' as status,
...
SELECT 
    'PROJ018' as code,
    'SL이노베이션 친환경 에너지 솔루션 개발' as name,
    'SI' as project_type,
    'IN_PROGRESS' as status,
...
SELECT 
    'PROJ019' as code,
    'SL텔레콤 5G 네트워크 최적화 프로젝트' as name,
    'SI' as project_type,
    'IN_PROGRESS' as status,
...
-- GGS그룹 파트너 기준 프로젝트 생성
-- PAR042: GGS칼텍스 파트너
INSERT INTO projects (code, name, project_type, status, start_date, end_date, company_id, created_by, updated_by)
SELECT 
    'PROJ041' as code,
    'GGS칼텍스 스마트 에너지 관리 시스템 구축' as name,
    'SI' as project_type,
    'IN_PROGRESS' as status,
...
SELECT 
    'PROJ042' as code,
    'GGS리테일 편의점 디지털 전환 프로젝트' as name,
    'SI' as project_type,
    'IN_PROGRESS' as status,
...
SELECT 
    'PROJ045' as code,
    'GGS EPS 에너지 솔루션 개발 프로젝트' as name,
    'SI' as project_type,
    'IN_PROGRESS' as status,
...
SELECT 
    'PROJ047' as code,
    'GGS수퍼마켓 디지털 매장 관리 시스템 구축' as name,
    'SI' as project_type,
    'IN_PROGRESS' as status,
...
SELECT 
    'PROJ050' as code,
    '한파에어로스페이스 항공우주 소프트웨어 개발' as name,
    'SI' as project_type,
    'IN_PROGRESS' as status,
...
SELECT 
    'PROJ055' as code,
    '한파투자증권 모바일 트레이딩 플랫폼 개발' as name,
    'SI' as project_type,
    'IN_PROGRESS' as status,
...
SELECT 
    'PROJ057' as code,
    '대구조선해양 스마트 조선소 구축 프로젝트' as name,
    'SI' as project_type,
    'IN_PROGRESS' as status,
...
SELECT 
    'PROJ063' as code,
    '한증항공 스마트 항공기 관리 시스템 구축' as name,
    'SI' as project_type,
    'IN_PROGRESS' as status,
...
SELECT 
    'PROJ067' as code,
    '한증중공업 대형 크레인 제어 시스템 개발' as name,
    'SI' as project_type,
    'IN_PROGRESS' as status,
...
SELECT 
    'PROJ077' as code,
    '야놀자고 숙박 플랫폼 AI 최적화 프로젝트' as name,
    'SI' as project_type,
    'IN_PROGRESS' as status,
    '2025-05-15' as start_date,
    (DATE '2025-05-15' + INTERVAL '3 months' - INTERVAL '1 day')::date as end_date,
...
SELECT 
    'PROJ079' as code,
    '당근마켓고 중고거래 AI 매칭 시스템 개발' as name,
    'SI' as project_type,
    'IN_PROGRESS' as status,
    '2025-07-15' as start_date,
    (DATE '2025-07-15' + INTERVAL '3 months' - INTERVAL '1 day')::date as end_date,
...
SELECT 
    'PROJ080' as code,
    '요기요고 실시간 배달 최적화 시스템 개발' as name,
    'SI' as project_type,
    'IN_PROGRESS' as status,
    '2025-08-15' as start_date,
    (DATE '2025-08-15' + INTERVAL '3 months' - INTERVAL '1 day')::date as end_date,
...
SELECT 
    'PROJ084' as code,
    '마이크로소프트우 Azure 클라우드 플랫폼 개발' as name,
    'SI' as project_type,
    'IN_PROGRESS' as status,
    '2025-02-10' as start_date,
    (DATE '2025-02-10' + INTERVAL '3 months' - INTERVAL '1 day')::date as end_date,
...
SELECT 
    'PROJ088' as code,
    'IBMZ 왓슨 AI 비즈니스 솔루션 개발' as name,
    'SI' as project_type,
    'IN_PROGRESS' as status,
    '2025-06-10' as start_date,
    (DATE '2025-06-10' + INTERVAL '3 months' - INTERVAL '1 day')::date as end_date,
...
SELECT 
    'PROJ089' as code,
    '오라클고 데이터베이스 클라우드 전환 프로젝트' as name,
    'SI' as project_type,
    'IN_PROGRESS' as status,
    '2025-07-10' as start_date,
    (DATE '2025-07-10' + INTERVAL '3 months' - INTERVAL '1 day')::date as end_date,
...
SELECT 
    'PROJ092' as code,
    'NVIDIAZ AI 가속기 개발 프로젝트' as name,
    'SI' as project_type,
    'IN_PROGRESS' as status,
    '2025-02-15' as start_date,
    (DATE '2025-02-15' + INTERVAL '3 months' - INTERVAL '1 day')::date as end_date,
...
SELECT 
    'PROJ096' as code,
    'MSG 게임 스튜디오 클라우드 게임 개발' as name,
    'SI' as project_type,
    'IN_PROGRESS' as status,
    '2025-06-15' as start_date,
    (DATE '2025-06-15' + INTERVAL '3 months' - INTERVAL '1 day')::date as end_date,
...
SELECT 
    'PROJ099' as code,
    '블리자드투 e스포츠 플랫폼 개발 프로젝트' as name,
    'SI' as project_type,
    'IN_PROGRESS' as status,
    '2025-01-20' as start_date,
    (DATE '2025-01-20' + INTERVAL '3 months' - INTERVAL '1 day')::date as end_date,
...
-- NumberinGGService에서 사용하는 프로젝트 코드 시퀀스 초기화
